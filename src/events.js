...
const App = () => {
  ...
  const events = [
    ...
    {
      src: event8,
      alt: "Farewell Cabinet",
      title: "Farewell Cabinet",
      month: "January",
    },
    {
      src: event9,
      alt: "KMBA on The Road",
      title: "KMBA on The Road",
      month: "IF we want",
    },
  ...
  return (
    <div
      className="bg-full min-h-screen"
      style={{
    ...
    >
      ...
      <div className="text-center mx-auto mb-12 lg:px-20 mt-10">
        <h2 className="text-2xl leading-normal mb-2 font-bold text-white py-4">
          KMBA Events
        </h2>
      </div>
          ...
          >
            {event.title === "Lunar New Year" ? (
              <div className="relative overflow-hidden cursor-pointer mb-6">
                ...
                >
                  <Link to="/login" class="text-blue-500 underline">
                    Regist Here
                  </Link>
                  <img
              ...
              <div className="relative overflow-hidden cursor-pointer mb-6">
                <a
                  href={event.src}
                  data-gallery="gallery1"
                  data-glightbox={`title: ${event.title}; description: Join us for Comstud, a study event like no other!`}
                  className="glightbox3"
                >
                  <img
                    className="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              ...
              <div className="relative overflow-hidden cursor-pointer mb-6">
                <a
                  href={event.src}
                  data-gallery="gallery1"
                  data-glightbox={`title: ${event.title}; description: Lets Join PPD`}
                  className="glightbox3"
                >
                  <img
                    className="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              ...
              <div className="relative overflow-hidden cursor-pointer mb-6">
                <a
                  href={event.src}
                  data-gallery="gallery1"
                  data-glightbox={`title: ${event.title}; description: Lets Join this Event`}
                  className="glightbox3"
                >
                  <img
                    className="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              ...
              <div className="relative overflow-hidden cursor-pointer mb-6">
                <a
                  href={event.src}
                  data-gallery="gallery1"
                  data-glightbox={`title: ${event.title}; description: This is a wider card with supporting text below as a natural lead-in to additional content`}
                  className="glightbox3"
                >
                  <img
                    className="block w-full h-auto transform duration-500 grayscale hover:scale-125"
